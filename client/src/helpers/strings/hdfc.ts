...
const strings: PlatformStrings = {
  ...
  PROOF_FORM_TITLE_REGISTRATION_INSTRUCTIONS: `
    ...
    the subject received after September 1st, 2023 to complete registration. Base ETH is required to submit a
  ...
  NO_EMAILS_ERROR: `
    No emails found.
    Please ensure you are using an email attached to a HDFC account with a receipt after 9/1/23.
  `,
