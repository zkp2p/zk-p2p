...
describe("WiseRamp", () => {
  ...
  describe("#register", async () => {
    ...
    async function subject(): Promise<any> {
      return ramp.connect(subjectCaller.wallet).register(subjectProof);
    }
  ...
  context("when the on and off ramper are registered", async () => {
    ...
    beforeEach(async () => {
      ...
      await ramp.connect(onRamperTwo.wallet).register(onRamperTwoProof);
      await ramp.connect(maliciousOnRamper.wallet).register(maliciousOnRamperProof);
