...
template NamecheapSubjectRegex(msg_bytes) {
	...
	component and[77][num_bytes];
	component multi_or[7][num_bytes];
	signal states[num_bytes+1][65];
	signal states_tmp[num_bytes+1][65];
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		lt[1][i].in[1] <== 127;
		and[51][i] = AND();
		and[51][i].a <== lt[0][i].out;
		and[51][i].b <== lt[1][i].out;
		eq[29][i] = IsEqual();
		eq[29][i].in[0] <== in[i];
		eq[29][i].in[1] <== 1;
		eq[30][i] = IsEqual();
		...
		multi_or[0][i].in[0] <== and[51][i].out;
		multi_or[0][i].in[1] <== eq[29][i].out;
		multi_or[0][i].in[2] <== eq[30][i].out;
		multi_or[0][i].in[3] <== eq[31][i].out;
		multi_or[0][i].in[4] <== eq[32][i].out;
		multi_or[0][i].in[5] <== eq[33][i].out;
		multi_or[0][i].in[6] <== eq[34][i].out;
		multi_or[0][i].in[7] <== eq[35][i].out;
		multi_or[0][i].in[8] <== eq[36][i].out;
		multi_or[0][i].in[9] <== eq[37][i].out;
		...
		lt[3][i].in[1] <== 191;
		and[53][i] = AND();
		and[53][i].a <== lt[2][i].out;
		and[53][i].b <== lt[3][i].out;
		and[54][i] = AND();
		and[54][i].a <== states[i][53];
		and[54][i].b <== and[53][i].out;
		multi_or[1][i] = MultiOR(2);
		multi_or[1][i].in[0] <== and[52][i].out;
		multi_or[1][i].in[1] <== and[54][i].out;
		states[i+1][52] <== multi_or[1][i].out;
		lt[4][i] = LessEqThan(8);
		lt[4][i].in[0] <== 194;
		lt[4][i].in[1] <== in[i];
		lt[5][i] = LessEqThan(8);
		...
		lt[5][i].in[1] <== 223;
		and[55][i] = AND();
		and[55][i].a <== lt[4][i].out;
		and[55][i].b <== lt[5][i].out;
		and[56][i] = AND();
		...
		multi_or[2][i].in[0] <== and[56][i].out;
		multi_or[2][i].in[1] <== and[58][i].out;
		multi_or[2][i].in[2] <== and[59][i].out;
		multi_or[2][i].in[3] <== and[61][i].out;
		states[i+1][53] <== multi_or[2][i].out;
		eq[38][i] = IsEqual();
		eq[38][i].in[0] <== in[i];
		eq[38][i].in[1] <== 224;
		and[62][i] = AND();
		and[62][i].a <== states[i][51];
		and[62][i].b <== eq[38][i].out;
		states[i+1][54] <== and[62][i].out;
		eq[39][i] = IsEqual();
		eq[39][i].in[0] <== in[i];
		eq[39][i].in[1] <== 225;
		eq[40][i] = IsEqual();
		...
		eq[52][i].in[1] <== 239;
		and[63][i] = AND();
		and[63][i].a <== states[i][51];
		multi_or[3][i] = MultiOR(14);
		multi_or[3][i].in[0] <== eq[39][i].out;
		multi_or[3][i].in[1] <== eq[40][i].out;
		multi_or[3][i].in[2] <== eq[41][i].out;
		multi_or[3][i].in[3] <== eq[42][i].out;
		multi_or[3][i].in[4] <== eq[43][i].out;
		multi_or[3][i].in[5] <== eq[44][i].out;
		multi_or[3][i].in[6] <== eq[45][i].out;
		multi_or[3][i].in[7] <== eq[46][i].out;
		multi_or[3][i].in[8] <== eq[47][i].out;
		multi_or[3][i].in[9] <== eq[48][i].out;
		multi_or[3][i].in[10] <== eq[49][i].out;
		multi_or[3][i].in[11] <== eq[50][i].out;
		multi_or[3][i].in[12] <== eq[51][i].out;
		multi_or[3][i].in[13] <== eq[52][i].out;
		and[63][i].b <== multi_or[3][i].out;
		...
		lt[11][i].in[1] <== 191;
		and[64][i] = AND();
		and[64][i].a <== lt[10][i].out;
		and[64][i].b <== lt[11][i].out;
		and[65][i] = AND();
		and[65][i].a <== states[i][57];
		and[65][i].b <== and[64][i].out;
		and[66][i] = AND();
		and[66][i].a <== states[i][58];
		and[66][i].b <== and[53][i].out;
		eq[53][i] = IsEqual();
		eq[53][i].in[0] <== in[i];
		eq[53][i].in[1] <== 128;
		eq[54][i] = IsEqual();
		...
		multi_or[4][i].in[2] <== eq[55][i].out;
		multi_or[4][i].in[3] <== eq[56][i].out;
		multi_or[4][i].in[4] <== eq[57][i].out;
		multi_or[4][i].in[5] <== eq[58][i].out;
		multi_or[4][i].in[6] <== eq[59][i].out;
		multi_or[4][i].in[7] <== eq[60][i].out;
		multi_or[4][i].in[8] <== eq[61][i].out;
		multi_or[4][i].in[9] <== eq[62][i].out;
		multi_or[4][i].in[10] <== eq[63][i].out;
		multi_or[4][i].in[11] <== eq[64][i].out;
		multi_or[4][i].in[12] <== eq[65][i].out;
		multi_or[4][i].in[13] <== eq[66][i].out;
		multi_or[4][i].in[14] <== eq[67][i].out;
		multi_or[4][i].in[15] <== eq[68][i].out;
		and[67][i].b <== multi_or[4][i].out;
		multi_or[5][i] = MultiOR(4);
		multi_or[5][i].in[0] <== and[63][i].out;
		multi_or[5][i].in[1] <== and[65][i].out;
		multi_or[5][i].in[2] <== and[66][i].out;
		multi_or[5][i].in[3] <== and[67][i].out;
		states[i+1][55] <== multi_or[5][i].out;
		eq[69][i] = IsEqual();
		eq[69][i].in[0] <== in[i];
		eq[69][i].in[1] <== 237;
		and[68][i] = AND();
		and[68][i].a <== states[i][51];
		and[68][i].b <== eq[69][i].out;
		...
		eq[73][i].in[1] <== 243;
		and[70][i] = AND();
		and[70][i].a <== states[i][51];
		multi_or[6][i] = MultiOR(3);
		multi_or[6][i].in[0] <== eq[71][i].out;
		multi_or[6][i].in[1] <== eq[72][i].out;
		multi_or[6][i].in[2] <== eq[73][i].out;
		and[70][i].b <== multi_or[6][i].out;
		...
		and[71][i].b <== eq[74][i].out;
		states[i+1][59] <== and[71][i].out;
		and[72][i] = AND();
		and[72][i].a <== states[i][52];
	...
	for (var i = 0; i <= num_bytes; i++) {
		is_accepted.in[i] <== states[i][64];
	}
	out <== is_accepted.out;
	signal is_consecutive[msg_bytes+1][3];
	is_consecutive[msg_bytes][2] <== 0;
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][64] * (1 - is_consecutive[msg_bytes-i][2]) + is_consecutive[msg_bytes-i][2];
		is_consecutive[msg_bytes-1-i][1] <== state_changed[msg_bytes-i].out * is_consecutive[msg_bytes-1-i][0];
		is_consecutive[msg_bytes-1-i][2] <== ORAnd()([(1 - from_zero_enabled[msg_bytes-i+1]), states[num_bytes-i][64], is_consecutive[msg_bytes-1-i][1]]);
	}
