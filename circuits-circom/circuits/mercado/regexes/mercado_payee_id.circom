...
template MercadoPayeeIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		eq[2][i].in[1] <== 58;
		and[2][i] = AND();
		and[2][i].a <== states[i][51];
		and[2][i].b <== eq[2][i].out;
		and[3][i] = AND();
		and[3][i].a <== states[i][58];
		...
		multi_or[10][i].in[0] <== eq[1][i].out;
		multi_or[10][i].in[1] <== eq[0][i].out;
		multi_or[10][i].in[2] <== eq[13][i].out;
		multi_or[10][i].in[3] <== eq[14][i].out;
		multi_or[10][i].in[4] <== eq[15][i].out;
		multi_or[10][i].in[5] <== eq[16][i].out;
		multi_or[10][i].in[6] <== eq[17][i].out;
		multi_or[10][i].in[7] <== eq[18][i].out;
		multi_or[10][i].in[8] <== eq[19][i].out;
		multi_or[10][i].in[9] <== eq[20][i].out;
		multi_or[10][i].in[10] <== eq[21][i].out;
		multi_or[10][i].in[11] <== eq[22][i].out;
		multi_or[10][i].in[12] <== eq[3][i].out;
		...
		and[59][i].b <== eq[23][i].out;
		states[i+1][48] <== and[59][i].out;
		state_changed[i].in[47] <== states[i+1][48];
		and[60][i] = AND();
		and[60][i].a <== states[i][39];
		and[60][i].b <== eq[0][i].out;
		states[i+1][49] <== and[60][i].out;
		state_changed[i].in[48] <== states[i+1][49];
		and[61][i] = AND();
		and[61][i].a <== states[i][48];
		and[61][i].b <== eq[3][i].out;
		states[i+1][50] <== and[61][i].out;
		state_changed[i].in[49] <== states[i+1][50];
		eq[24][i] = IsEqual();
		eq[24][i].in[0] <== in[i];
		eq[24][i].in[1] <== 85;
		and[62][i] = AND();
		and[62][i].a <== states[i][48];
		and[62][i].b <== eq[24][i].out;
		states[i+1][51] <== and[62][i].out;
		state_changed[i].in[50] <== states[i+1][51];
		and[63][i] = AND();
		and[63][i].a <== states[i][49];
		and[63][i].b <== eq[1][i].out;
		states[i+1][52] <== and[63][i].out;
		state_changed[i].in[51] <== states[i+1][52];
		and[64][i] = AND();
		and[64][i].a <== states[i][50];
		and[64][i].b <== eq[0][i].out;
		states[i+1][53] <== and[64][i].out;
		state_changed[i].in[52] <== states[i+1][53];
		and[65][i] = AND();
		and[65][i].a <== states[i][51];
		and[65][i].b <== eq[3][i].out;
		states[i+1][54] <== and[65][i].out;
		state_changed[i].in[53] <== states[i+1][54];
		and[66][i] = AND();
		and[66][i].a <== states[i][52];
		and[66][i].b <== eq[23][i].out;
		and[67][i] = AND();
		and[67][i].a <== states[i][53];
		and[67][i].b <== eq[1][i].out;
		multi_or[12][i] = MultiOR(2);
		multi_or[12][i].in[0] <== and[66][i].out;
		multi_or[12][i].in[1] <== and[67][i].out;
		states[i+1][55] <== multi_or[12][i].out;
		state_changed[i].in[54] <== states[i+1][55];
		and[68][i] = AND();
		and[68][i].a <== states[i][3];
		and[68][i].b <== eq[3][i].out;
		states[i+1][56] <== and[68][i].out;
		state_changed[i].in[55] <== states[i+1][56];
		and[69][i] = AND();
		and[69][i].a <== states[i][54];
		and[69][i].b <== eq[0][i].out;
		states[i+1][57] <== and[69][i].out;
		state_changed[i].in[56] <== states[i+1][57];
		and[70][i] = AND();
		and[70][i].a <== states[i][55];
		and[70][i].b <== eq[24][i].out;
		and[71][i] = AND();
		and[71][i].a <== states[i][57];
		and[71][i].b <== eq[1][i].out;
		multi_or[13][i] = MultiOR(2);
		multi_or[13][i].in[0] <== and[70][i].out;
		multi_or[13][i].in[1] <== and[71][i].out;
		states[i+1][58] <== multi_or[13][i].out;
		state_changed[i].in[57] <== states[i+1][58];
		eq[25][i] = IsEqual();
		eq[25][i].in[0] <== in[i];
		eq[25][i].in[1] <== 60;
		and[72][i] = AND();
		and[72][i].a <== states[i][7];
		and[72][i].b <== eq[25][i].out;
		and[73][i] = AND();
		and[73][i].a <== states[i][8];
		and[73][i].b <== eq[25][i].out;
		and[74][i] = AND();
		and[74][i].a <== states[i][13];
		and[74][i].b <== eq[25][i].out;
		and[75][i] = AND();
		and[75][i].a <== states[i][29];
		and[75][i].b <== eq[25][i].out;
		and[76][i] = AND();
		and[76][i].a <== states[i][34];
		and[76][i].b <== eq[25][i].out;
		multi_or[14][i] = MultiOR(5);
		multi_or[14][i].in[0] <== and[72][i].out;
		multi_or[14][i].in[1] <== and[73][i].out;
		multi_or[14][i].in[2] <== and[74][i].out;
		multi_or[14][i].in[3] <== and[75][i].out;
		multi_or[14][i].in[4] <== and[76][i].out;
		states[i+1][59] <== multi_or[14][i].out;
		state_changed[i].in[58] <== states[i+1][59];
		and[77][i] = AND();
		and[77][i].a <== states[i][8];
		and[77][i].b <== eq[3][i].out;
		states[i+1][60] <== and[77][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][45] * states[i+2][46];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][45] * states[i+2][47];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][46] * states[i+2][46];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][47] * states[i+2][46];
