...
template BodyHashRegexV2(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[1] <== and[0][i].out;
		multi_or[7][i].in[2] <== eq[23][i].out;
		multi_or[7][i].in[3] <== eq[24][i].out;
		multi_or[7][i].in[4] <== eq[25][i].out;
		multi_or[7][i].in[5] <== eq[26][i].out;
		multi_or[7][i].in[6] <== eq[27][i].out;
		multi_or[7][i].in[7] <== eq[28][i].out;
		multi_or[7][i].in[8] <== eq[29][i].out;
		multi_or[7][i].in[9] <== eq[30][i].out;
		multi_or[7][i].in[10] <== eq[31][i].out;
		multi_or[7][i].in[11] <== eq[32][i].out;
		multi_or[7][i].in[12] <== eq[33][i].out;
		multi_or[7][i].in[13] <== eq[34][i].out;
		multi_or[7][i].in[14] <== eq[21][i].out;
		...
		multi_or[9][i].in[3] <== eq[38][i].out;
		and[22][i].b <== multi_or[9][i].out;
		and[23][i] = AND();
