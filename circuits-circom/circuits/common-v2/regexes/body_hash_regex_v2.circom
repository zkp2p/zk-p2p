...
template BodyHashRegexV2(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[7][i].in[1] <== and[14][i].out;
		multi_or[7][i].in[2] <== and[15][i].out;
		multi_or[7][i].in[3] <== and[16][i].out;
		...
		and[23][i].b <== multi_or[12][i].out;
		and[24][i] = AND();
		and[24][i].a <== states[i][7];
		multi_or[13][i] = MultiOR(4);
		multi_or[13][i].in[0] <== eq[35][i].out;
		multi_or[13][i].in[1] <== eq[36][i].out;
		multi_or[13][i].in[2] <== eq[37][i].out;
		multi_or[13][i].in[3] <== eq[38][i].out;
		and[24][i].b <== multi_or[13][i].out;
		multi_or[14][i] = MultiOR(3);
		multi_or[14][i].in[0] <== and[22][i].out;
		multi_or[14][i].in[1] <== and[23][i].out;
		multi_or[14][i].in[2] <== and[24][i].out;
		states[i+1][6] <== multi_or[14][i].out;
		state_changed[i].in[5] <== states[i+1][6];
		and[25][i] = AND();
		and[25][i].a <== states[i][5];
		and[25][i].b <== eq[22][i].out;
		states[i+1][7] <== and[25][i].out;
		...
		multi_or[15][i].in[0] <== and[26][i].out;
		multi_or[15][i].in[1] <== and[27][i].out;
		states[i+1][8] <== multi_or[15][i].out;
		...
		multi_or[16][i].in[0] <== and[28][i].out;
		multi_or[16][i].in[1] <== and[29][i].out;
		states[i+1][9] <== multi_or[16][i].out;
		...
		multi_or[18][i].in[0] <== eq[40][i].out;
		multi_or[18][i].in[1] <== eq[3][i].out;
		and[32][i].b <== multi_or[18][i].out;
		...
		multi_or[19][i].in[0] <== eq[41][i].out;
		multi_or[19][i].in[1] <== eq[42][i].out;
		and[33][i].b <== multi_or[19][i].out;
		...
		multi_or[20][i].in[0] <== eq[43][i].out;
		multi_or[20][i].in[1] <== eq[44][i].out;
		and[34][i].b <== multi_or[20][i].out;
		...
		multi_or[21][i].in[0] <== eq[45][i].out;
		multi_or[21][i].in[1] <== eq[46][i].out;
		and[35][i].b <== multi_or[21][i].out;
		states[i+1][14] <== and[35][i].out;
		state_changed[i].in[13] <== states[i+1][14];
		and[36][i] = AND();
		and[36][i].a <== states[i][14];
		and[36][i].b <== eq[8][i].out;
		...
		multi_or[22][i].in[0] <== eq[47][i].out;
		multi_or[22][i].in[1] <== eq[48][i].out;
		and[37][i].b <== multi_or[22][i].out;
