...
include "./regexes/garanti/garanti_subject.circom";
include "./regexes/garanti/garanti_payer_details.circom";
include "./regexes/garanti/garanti_payment_details.circom";
...
template GarantiSendEmail(max_header_bytes, max_body_bytes, n, k, pack_size) {
    ...
    signal (from_regex_out, from_regex_reveal[max_header_bytes]) <== FromRegexV3(max_header_bytes)(in_padded);
    from_regex_out === 1;
