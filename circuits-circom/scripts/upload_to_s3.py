...
parser.add_argument('--prefix_to_tar', type=str, default='venmo_send.zkey,venmo_registration.zkey', help='Prefix to match for files in order to compress to a .tar.gz and upload')
parser.add_argument('--prefix', type=str, default='venmo_send.wasm,venmo_registration.wasm,venmo_send_vkey.json,venmo_registration_vkey.json', help='Comma-seperated prefixes to upload without compression')
