...
parser.add_argument('--prefix', type=str, default='''
                    ...
                    paylah_registration.wasm,paylah_registration_veky.json,paylah_registration.dat,paylah_registration.zkey''', help='Comma-seperated prefixes to upload without compression')
