...
template FromRegexNew(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[3][i].in[16] <== eq[25][i].out;
		multi_or[3][i].in[17] <== eq[26][i].out;
		multi_or[3][i].in[18] <== eq[13][i].out;
		multi_or[3][i].in[19] <== eq[14][i].out;
		multi_or[3][i].in[20] <== eq[27][i].out;
		multi_or[3][i].in[21] <== eq[17][i].out;
		...
		multi_or[12][i].in[0] <== and[14][i].out;
		multi_or[12][i].in[1] <== and[36][i].out;
		multi_or[12][i].in[2] <== eq[49][i].out;
		multi_or[12][i].in[3] <== eq[50][i].out;
		multi_or[12][i].in[4] <== eq[51][i].out;
		multi_or[12][i].in[5] <== eq[52][i].out;
		multi_or[12][i].in[6] <== eq[53][i].out;
		multi_or[12][i].in[7] <== eq[54][i].out;
		multi_or[12][i].in[8] <== eq[55][i].out;
		multi_or[12][i].in[9] <== eq[56][i].out;
		multi_or[12][i].in[10] <== eq[28][i].out;
		multi_or[12][i].in[11] <== eq[29][i].out;
		multi_or[12][i].in[12] <== eq[12][i].out;
		multi_or[12][i].in[13] <== eq[30][i].out;
		multi_or[12][i].in[14] <== eq[31][i].out;
		multi_or[12][i].in[15] <== eq[32][i].out;
		multi_or[12][i].in[16] <== eq[33][i].out;
		multi_or[12][i].in[17] <== eq[34][i].out;
		multi_or[12][i].in[18] <== eq[35][i].out;
		multi_or[12][i].in[19] <== eq[36][i].out;
		multi_or[12][i].in[20] <== eq[37][i].out;
		multi_or[12][i].in[21] <== eq[38][i].out;
		multi_or[12][i].in[22] <== eq[39][i].out;
		multi_or[12][i].in[23] <== eq[15][i].out;
		multi_or[12][i].in[24] <== eq[16][i].out;
		...
		multi_or[13][i].in[1] <== and[38][i].out;
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][2] * states[i+2][13];
		is_substr0[i][3] <== is_substr0[i][2] + states[i+1][13] * states[i+2][13];
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][13] * states[i+2][14];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][14] * states[i+2][13];
		...
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][15] * states[i+2][13];
