...
template MercadoPayeeIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		eq[2][i].in[1] <== 58;
		and[2][i] = AND();
		and[2][i].a <== states[i][55];
		and[2][i].b <== eq[2][i].out;
		and[3][i] = AND();
		and[3][i].a <== states[i][62];
		...
		and[60][i] = AND();
		and[60][i].a <== states[i][45];
		and[60][i].b <== eq[1][i].out;
		states[i+1][47] <== and[60][i].out;
		state_changed[i].in[46] <== states[i+1][47];
		and[61][i] = AND();
		and[61][i].a <== states[i][46];
		and[61][i].b <== eq[5][i].out;
		and[62][i] = AND();
		and[62][i].a <== states[i][47];
		and[62][i].b <== eq[5][i].out;
		multi_or[11][i] = MultiOR(2);
		multi_or[11][i].in[0] <== and[61][i].out;
		multi_or[11][i].in[1] <== and[62][i].out;
		states[i+1][48] <== multi_or[11][i].out;
		state_changed[i].in[47] <== states[i+1][48];
		and[63][i] = AND();
		and[63][i].a <== states[i][48];
		...
		and[69][i].b <== eq[24][i].out;
		states[i+1][55] <== and[69][i].out;
		state_changed[i].in[54] <== states[i+1][55];
		and[70][i] = AND();
		and[70][i].a <== states[i][53];
		and[70][i].b <== eq[1][i].out;
		states[i+1][56] <== and[70][i].out;
		state_changed[i].in[55] <== states[i+1][56];
		and[71][i] = AND();
		and[71][i].a <== states[i][54];
		and[71][i].b <== eq[0][i].out;
		states[i+1][57] <== and[71][i].out;
		state_changed[i].in[56] <== states[i+1][57];
		and[72][i] = AND();
		and[72][i].a <== states[i][55];
		and[72][i].b <== eq[3][i].out;
		states[i+1][58] <== and[72][i].out;
		state_changed[i].in[57] <== states[i+1][58];
		and[73][i] = AND();
		and[73][i].a <== states[i][56];
		and[73][i].b <== eq[23][i].out;
		and[74][i] = AND();
		and[74][i].a <== states[i][57];
		and[74][i].b <== eq[1][i].out;
		multi_or[12][i] = MultiOR(2);
		multi_or[12][i].in[0] <== and[73][i].out;
		multi_or[12][i].in[1] <== and[74][i].out;
		states[i+1][59] <== multi_or[12][i].out;
		state_changed[i].in[58] <== states[i+1][59];
		and[75][i] = AND();
		and[75][i].a <== states[i][3];
		and[75][i].b <== eq[3][i].out;
		...
		and[77][i].b <== eq[24][i].out;
		and[78][i] = AND();
		and[78][i].a <== states[i][61];
		and[78][i].b <== eq[1][i].out;
		multi_or[13][i] = MultiOR(2);
		multi_or[13][i].in[0] <== and[77][i].out;
		multi_or[13][i].in[1] <== and[78][i].out;
		states[i+1][62] <== multi_or[13][i].out;
		state_changed[i].in[61] <== states[i+1][62];
		eq[25][i] = IsEqual();
		eq[25][i].in[0] <== in[i];
		eq[25][i].in[1] <== 60;
		and[79][i] = AND();
		and[79][i].a <== states[i][7];
		and[79][i].b <== eq[25][i].out;
		and[80][i] = AND();
		and[80][i].a <== states[i][8];
		and[80][i].b <== eq[25][i].out;
		and[81][i] = AND();
		and[81][i].a <== states[i][13];
		and[81][i].b <== eq[25][i].out;
		and[82][i] = AND();
		and[82][i].a <== states[i][29];
		and[82][i].b <== eq[25][i].out;
		and[83][i] = AND();
		and[83][i].a <== states[i][34];
		and[83][i].b <== eq[25][i].out;
		multi_or[14][i] = MultiOR(5);
		multi_or[14][i].in[0] <== and[79][i].out;
		multi_or[14][i].in[1] <== and[80][i].out;
		multi_or[14][i].in[2] <== and[81][i].out;
		multi_or[14][i].in[3] <== and[82][i].out;
		multi_or[14][i].in[4] <== and[83][i].out;
		states[i+1][63] <== multi_or[14][i].out;
		state_changed[i].in[62] <== states[i+1][63];
		and[84][i] = AND();
		and[84][i].a <== states[i][8];
	...
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][41];
	}
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][41] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][42] * states[i+2][45];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][45] * states[i+2][47];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][47] * states[i+2][41];
		is_substr0[i][7] <== is_substr0[i][6] + states[i+1][47] * states[i+2][48];
		is_substr0[i][8] <== is_substr0[i][7] + states[i+1][48] * states[i+2][41];
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][48] * states[i+2][49];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][49] * states[i+2][50];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][50] * states[i+2][51];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][51] * states[i+2][41];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][51] * states[i+2][52];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][52] * states[i+2][41];
