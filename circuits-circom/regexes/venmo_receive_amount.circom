...
template VenmoReceiveAmountRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[2][i].in[25] <== eq[23][i].out;
		multi_or[2][i].in[26] <== eq[24][i].out;
		multi_or[2][i].in[27] <== eq[25][i].out;
		...
		multi_or[3][i].in[16] <== eq[22][i].out;
		...
		multi_or[5][i].in[2] <== and[1][i].out;
		multi_or[5][i].in[3] <== eq[0][i].out;
		multi_or[5][i].in[4] <== eq[1][i].out;
		multi_or[5][i].in[5] <== eq[2][i].out;
		multi_or[5][i].in[6] <== eq[3][i].out;
		multi_or[5][i].in[7] <== eq[4][i].out;
		multi_or[5][i].in[8] <== eq[5][i].out;
		multi_or[5][i].in[9] <== eq[6][i].out;
		multi_or[5][i].in[10] <== eq[7][i].out;
		multi_or[5][i].in[11] <== eq[8][i].out;
		multi_or[5][i].in[12] <== eq[9][i].out;
		multi_or[5][i].in[13] <== eq[10][i].out;
		multi_or[5][i].in[14] <== eq[11][i].out;
		...
		eq[33][i].in[1] <== 120;
		and[15][i] = AND();
		and[15][i].a <== states[i][16];
		multi_or[6][i] = MultiOR(22);
		multi_or[6][i].in[0] <== and[0][i].out;
		...
		multi_or[6][i].in[15] <== eq[27][i].out;
		multi_or[6][i].in[16] <== eq[28][i].out;
		multi_or[6][i].in[17] <== eq[29][i].out;
		multi_or[6][i].in[18] <== eq[30][i].out;
		multi_or[6][i].in[19] <== eq[31][i].out;
		multi_or[6][i].in[20] <== eq[32][i].out;
		multi_or[6][i].in[21] <== eq[33][i].out;
		...
		multi_or[7][i].in[0] <== and[16][i].out;
		multi_or[7][i].in[1] <== and[1][i].out;
		multi_or[7][i].in[2] <== eq[0][i].out;
		...
		multi_or[8][i].in[0] <== and[0][i].out;
		multi_or[8][i].in[1] <== and[18][i].out;
		multi_or[8][i].in[2] <== eq[0][i].out;
		...
		multi_or[8][i].in[17] <== eq[29][i].out;
		...
		lt[25][i].in[1] <== 111;
		and[22][i] = AND();
		and[22][i].a <== lt[24][i].out;
		and[22][i].b <== lt[25][i].out;
		and[23][i] = AND();
		and[23][i].a <== states[i][20];
		multi_or[9][i] = MultiOR(15);
		multi_or[9][i].in[0] <== and[21][i].out;
		multi_or[9][i].in[1] <== and[22][i].out;
		multi_or[9][i].in[2] <== and[1][i].out;
		multi_or[9][i].in[3] <== eq[0][i].out;
		multi_or[9][i].in[4] <== eq[1][i].out;
		multi_or[9][i].in[5] <== eq[2][i].out;
		multi_or[9][i].in[6] <== eq[3][i].out;
		multi_or[9][i].in[7] <== eq[4][i].out;
		multi_or[9][i].in[8] <== eq[5][i].out;
		multi_or[9][i].in[9] <== eq[6][i].out;
		multi_or[9][i].in[10] <== eq[7][i].out;
		multi_or[9][i].in[11] <== eq[8][i].out;
		multi_or[9][i].in[12] <== eq[9][i].out;
		multi_or[9][i].in[13] <== eq[10][i].out;
		multi_or[9][i].in[14] <== eq[11][i].out;
		and[23][i].b <== multi_or[9][i].out;
		...
		multi_or[10][i].in[2] <== and[1][i].out;
		multi_or[10][i].in[3] <== eq[0][i].out;
		multi_or[10][i].in[4] <== eq[1][i].out;
		multi_or[10][i].in[5] <== eq[2][i].out;
		multi_or[10][i].in[6] <== eq[3][i].out;
		multi_or[10][i].in[7] <== eq[4][i].out;
		multi_or[10][i].in[8] <== eq[5][i].out;
		multi_or[10][i].in[9] <== eq[6][i].out;
		multi_or[10][i].in[10] <== eq[7][i].out;
		multi_or[10][i].in[11] <== eq[8][i].out;
		multi_or[10][i].in[12] <== eq[9][i].out;
		multi_or[10][i].in[13] <== eq[10][i].out;
		multi_or[10][i].in[14] <== eq[11][i].out;
		multi_or[10][i].in[15] <== eq[34][i].out;
		multi_or[10][i].in[16] <== eq[35][i].out;
		and[26][i].b <== multi_or[10][i].out;
		and[27][i] = AND();
		...
		multi_or[11][i].in[5] <== and[13][i].out;
		multi_or[11][i].in[6] <== and[15][i].out;
		multi_or[11][i].in[7] <== and[17][i].out;
		multi_or[11][i].in[8] <== and[19][i].out;
		multi_or[11][i].in[9] <== and[20][i].out;
		multi_or[11][i].in[10] <== and[23][i].out;
		multi_or[11][i].in[11] <== and[26][i].out;
		multi_or[11][i].in[12] <== and[27][i].out;
		...
		states[i+1][4] <== and[32][i].out;
		state_changed[i].in[3] <== states[i+1][4];
		and[33][i] = AND();
		and[33][i].a <== states[i][4];
		and[33][i].b <== eq[30][i].out;
		states[i+1][5] <== and[33][i].out;
		state_changed[i].in[4] <== states[i+1][5];
		and[34][i] = AND();
		and[34][i].a <== states[i][5];
		and[34][i].b <== eq[12][i].out;
		states[i+1][6] <== and[34][i].out;
		state_changed[i].in[5] <== states[i+1][6];
		and[35][i] = AND();
		and[35][i].a <== states[i][6];
		and[35][i].b <== eq[20][i].out;
		states[i+1][7] <== and[35][i].out;
		state_changed[i].in[6] <== states[i+1][7];
		and[36][i] = AND();
		and[36][i].a <== states[i][7];
		and[36][i].b <== eq[15][i].out;
		states[i+1][8] <== and[36][i].out;
		state_changed[i].in[7] <== states[i+1][8];
		and[37][i] = AND();
		and[37][i].a <== states[i][8];
		and[37][i].b <== eq[13][i].out;
		states[i+1][9] <== and[37][i].out;
		state_changed[i].in[8] <== states[i+1][9];
		and[38][i] = AND();
		and[38][i].a <== states[i][9];
		and[38][i].b <== eq[29][i].out;
		states[i+1][10] <== and[38][i].out;
		...
		and[41][i].b <== eq[40][i].out;
		and[42][i] = AND();
		and[42][i].a <== states[i][13];
		and[42][i].b <== eq[40][i].out;
		and[43][i] = AND();
		and[43][i].a <== states[i][14];
		and[43][i].b <== eq[40][i].out;
		and[44][i] = AND();
		...
		and[46][i].b <== eq[40][i].out;
		and[47][i] = AND();
		and[47][i].a <== states[i][18];
		and[47][i].b <== eq[40][i].out;
		and[48][i] = AND();
		and[48][i].a <== states[i][19];
		and[48][i].b <== eq[40][i].out;
		and[49][i] = AND();
		and[49][i].a <== states[i][20];
		and[49][i].b <== eq[40][i].out;
		and[50][i] = AND();
		and[50][i].a <== states[i][21];
		and[50][i].b <== eq[40][i].out;
		and[51][i] = AND();
		and[51][i].a <== states[i][22];
		and[51][i].b <== eq[40][i].out;
		multi_or[14][i] = MultiOR(12);
		multi_or[14][i].in[0] <== and[40][i].out;
		multi_or[14][i].in[1] <== and[41][i].out;
		multi_or[14][i].in[2] <== and[42][i].out;
		multi_or[14][i].in[3] <== and[43][i].out;
		multi_or[14][i].in[4] <== and[44][i].out;
		multi_or[14][i].in[5] <== and[45][i].out;
		multi_or[14][i].in[6] <== and[46][i].out;
		multi_or[14][i].in[7] <== and[47][i].out;
		multi_or[14][i].in[8] <== and[48][i].out;
		multi_or[14][i].in[9] <== and[49][i].out;
		multi_or[14][i].in[10] <== and[50][i].out;
		multi_or[14][i].in[11] <== and[51][i].out;
		...
		and[55][i].b <== eq[42][i].out;
		states[i+1][16] <== and[55][i].out;
		...
		and[60][i].b <== eq[44][i].out;
		states[i+1][21] <== and[60][i].out;
		...
		eq[56][i].in[1] <== 57;
		and[61][i] = AND();
		and[61][i].a <== states[i][21];
		multi_or[15][i] = MultiOR(12);
		multi_or[15][i].in[0] <== eq[45][i].out;
		multi_or[15][i].in[1] <== eq[46][i].out;
		multi_or[15][i].in[2] <== eq[47][i].out;
		multi_or[15][i].in[3] <== eq[48][i].out;
		multi_or[15][i].in[4] <== eq[49][i].out;
		multi_or[15][i].in[5] <== eq[50][i].out;
		multi_or[15][i].in[6] <== eq[51][i].out;
		multi_or[15][i].in[7] <== eq[52][i].out;
		multi_or[15][i].in[8] <== eq[53][i].out;
		multi_or[15][i].in[9] <== eq[54][i].out;
		multi_or[15][i].in[10] <== eq[55][i].out;
		multi_or[15][i].in[11] <== eq[56][i].out;
		and[61][i].b <== multi_or[15][i].out;
		and[62][i] = AND();
		and[62][i].a <== states[i][22];
		and[62][i].b <== multi_or[15][i].out;
		multi_or[16][i] = MultiOR(2);
		multi_or[16][i].in[0] <== and[61][i].out;
		multi_or[16][i].in[1] <== and[62][i].out;
		states[i+1][22] <== multi_or[16][i].out;
		state_changed[i].in[21] <== states[i+1][22];
		and[63][i] = AND();
		and[63][i].a <== states[i][22];
		and[63][i].b <== eq[36][i].out;
		states[i+1][23] <== and[63][i].out;
		state_changed[i].in[22] <== states[i+1][23];
		and[64][i] = AND();
		and[64][i].a <== states[i][23];
		and[64][i].b <== eq[38][i].out;
		states[i+1][24] <== and[64][i].out;
