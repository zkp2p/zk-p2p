...
template VenmoPayerIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[1][i].in[0] <== eq[18][i].out;
		multi_or[1][i].in[1] <== eq[19][i].out;
		multi_or[1][i].in[2] <== eq[20][i].out;
		multi_or[1][i].in[3] <== eq[21][i].out;
		multi_or[1][i].in[4] <== eq[22][i].out;
		multi_or[1][i].in[5] <== eq[23][i].out;
		multi_or[1][i].in[6] <== eq[24][i].out;
		multi_or[1][i].in[7] <== eq[25][i].out;
		multi_or[1][i].in[8] <== eq[26][i].out;
		multi_or[1][i].in[9] <== eq[27][i].out;
