...
template PaylahPaymentIdRegex(msg_bytes) {
	...
	signal is_substr0[msg_bytes][21];
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][5] * states[i+2][6];
		is_substr0[i][6] <== is_substr0[i][5] + states[i+1][6] * states[i+2][7];
		is_substr0[i][7] <== is_substr0[i][6] + states[i+1][7] * states[i+2][8];
		is_substr0[i][8] <== is_substr0[i][7] + states[i+1][8] * states[i+2][9];
		is_substr0[i][9] <== is_substr0[i][8] + states[i+1][9] * states[i+2][10];
		is_substr0[i][10] <== is_substr0[i][9] + states[i+1][10] * states[i+2][11];
		is_substr0[i][11] <== is_substr0[i][10] + states[i+1][11] * states[i+2][12];
		is_substr0[i][12] <== is_substr0[i][11] + states[i+1][30] * states[i+2][31];
		is_substr0[i][13] <== is_substr0[i][12] + states[i+1][31] * states[i+2][32];
		is_substr0[i][14] <== is_substr0[i][13] + states[i+1][32] * states[i+2][33];
		is_substr0[i][15] <== is_substr0[i][14] + states[i+1][33] * states[i+2][34];
		is_substr0[i][16] <== is_substr0[i][15] + states[i+1][34] * states[i+2][35];
		is_substr0[i][17] <== is_substr0[i][16] + states[i+1][35] * states[i+2][36];
		is_substr0[i][18] <== is_substr0[i][17] + states[i+1][36] * states[i+2][37];
		is_substr0[i][19] <== is_substr0[i][18] + states[i+1][37] * states[i+2][38];
		is_substr0[i][20] <== is_substr0[i][19] + states[i+1][38] * states[i+2][1];
		is_reveal0[i] <== is_substr0[i][20] * is_consecutive[i][1];
