...
template VenmoReceiveIdRegex(msg_bytes) {
	...
	component and[365][num_bytes];
	component multi_or[6][num_bytes];
	signal states[num_bytes+1][362];
	...
	for (var i = 0; i < num_bytes; i++) {
		state_changed[i] = MultiOR(361);
		eq[0][i] = IsEqual();
		eq[0][i].in[0] <== in[i];
		eq[0][i].in[1] <== 32;
		and[0][i] = AND();
		and[0][i].a <== states[i][361];
		...
		and[121][i] = AND();
		and[121][i].a <== states[i][118];
		and[121][i].b <== eq[0][i].out;
		...
		eq[42][i].in[1] <== 55;
		and[228][i] = AND();
		and[228][i].a <== states[i][226];
		and[228][i].b <== eq[42][i].out;
		...
		and[246][i].b <== eq[23][i].out;
		states[i+1][245] <== and[246][i].out;
		state_changed[i].in[244] <== states[i+1][245];
		and[247][i] = AND();
		and[247][i].a <== states[i][219];
		and[247][i].b <== eq[19][i].out;
		states[i+1][246] <== and[247][i].out;
		state_changed[i].in[245] <== states[i+1][246];
		and[248][i] = AND();
		and[248][i].a <== states[i][245];
		and[248][i].b <== eq[24][i].out;
		states[i+1][247] <== and[248][i].out;
		state_changed[i].in[246] <== states[i+1][247];
		and[249][i] = AND();
		and[249][i].a <== states[i][247];
		and[249][i].b <== eq[25][i].out;
		states[i+1][248] <== and[249][i].out;
		state_changed[i].in[247] <== states[i+1][248];
		and[250][i] = AND();
		and[250][i].a <== states[i][248];
		and[250][i].b <== eq[40][i].out;
		states[i+1][249] <== and[250][i].out;
		state_changed[i].in[248] <== states[i+1][249];
		and[251][i] = AND();
		and[251][i].a <== states[i][249];
		and[251][i].b <== eq[25][i].out;
		states[i+1][250] <== and[251][i].out;
		state_changed[i].in[249] <== states[i+1][250];
		and[252][i] = AND();
		and[252][i].a <== states[i][250];
		and[252][i].b <== eq[24][i].out;
		states[i+1][251] <== and[252][i].out;
		state_changed[i].in[250] <== states[i+1][251];
		and[253][i] = AND();
		and[253][i].a <== states[i][251];
		and[253][i].b <== eq[25][i].out;
		states[i+1][252] <== and[253][i].out;
		state_changed[i].in[251] <== states[i+1][252];
		and[254][i] = AND();
		and[254][i].a <== states[i][252];
		and[254][i].b <== eq[33][i].out;
		states[i+1][253] <== and[254][i].out;
		state_changed[i].in[252] <== states[i+1][253];
		and[255][i] = AND();
		and[255][i].a <== states[i][253];
		and[255][i].b <== eq[39][i].out;
		states[i+1][254] <== and[255][i].out;
		state_changed[i].in[253] <== states[i+1][254];
		and[256][i] = AND();
		and[256][i].a <== states[i][254];
		and[256][i].b <== eq[0][i].out;
		states[i+1][255] <== and[256][i].out;
		state_changed[i].in[254] <== states[i+1][255];
		eq[47][i] = IsEqual();
		eq[47][i].in[0] <== in[i];
		eq[47][i].in[1] <== 104;
		and[257][i] = AND();
		and[257][i].a <== states[i][255];
		and[257][i].b <== eq[47][i].out;
		states[i+1][256] <== and[257][i].out;
		state_changed[i].in[255] <== states[i+1][256];
		and[258][i] = AND();
		and[258][i].a <== states[i][256];
		and[258][i].b <== eq[32][i].out;
		states[i+1][257] <== and[258][i].out;
		state_changed[i].in[256] <== states[i+1][257];
		and[259][i] = AND();
		and[259][i].a <== states[i][257];
		and[259][i].b <== eq[33][i].out;
		states[i+1][258] <== and[259][i].out;
		state_changed[i].in[257] <== states[i+1][258];
		eq[48][i] = IsEqual();
		eq[48][i].in[0] <== in[i];
		eq[48][i].in[1] <== 102;
		and[260][i] = AND();
		and[260][i].a <== states[i][258];
		and[260][i].b <== eq[48][i].out;
		states[i+1][259] <== and[260][i].out;
		state_changed[i].in[258] <== states[i+1][259];
		and[261][i] = AND();
		and[261][i].a <== states[i][259];
		and[261][i].b <== eq[29][i].out;
		states[i+1][260] <== and[261][i].out;
		state_changed[i].in[259] <== states[i+1][260];
		and[262][i] = AND();
		and[262][i].a <== states[i][260];
		and[262][i].b <== eq[37][i].out;
		states[i+1][261] <== and[262][i].out;
		state_changed[i].in[260] <== states[i+1][261];
		and[263][i] = AND();
		and[263][i].a <== states[i][261];
		and[263][i].b <== eq[38][i].out;
		states[i+1][262] <== and[263][i].out;
		state_changed[i].in[261] <== states[i+1][262];
		and[264][i] = AND();
		and[264][i].a <== states[i][262];
		and[264][i].b <== eq[39][i].out;
		states[i+1][263] <== and[264][i].out;
		state_changed[i].in[262] <== states[i+1][263];
		and[265][i] = AND();
		and[265][i].a <== states[i][263];
		and[265][i].b <== eq[47][i].out;
		states[i+1][264] <== and[265][i].out;
		state_changed[i].in[263] <== states[i+1][264];
		and[266][i] = AND();
		and[266][i].a <== states[i][264];
		and[266][i].b <== eq[22][i].out;
		states[i+1][265] <== and[266][i].out;
		state_changed[i].in[264] <== states[i+1][265];
		and[267][i] = AND();
		and[267][i].a <== states[i][265];
		and[267][i].b <== eq[29][i].out;
		states[i+1][266] <== and[267][i].out;
		state_changed[i].in[265] <== states[i+1][266];
		and[268][i] = AND();
		and[268][i].a <== states[i][266];
		and[268][i].b <== eq[18][i].out;
		states[i+1][267] <== and[268][i].out;
		state_changed[i].in[266] <== states[i+1][267];
		and[269][i] = AND();
		and[269][i].a <== states[i][267];
		and[269][i].b <== eq[13][i].out;
		states[i+1][268] <== and[269][i].out;
		state_changed[i].in[267] <== states[i+1][268];
		and[270][i] = AND();
		and[270][i].a <== states[i][268];
		and[270][i].b <== eq[22][i].out;
		states[i+1][269] <== and[270][i].out;
		state_changed[i].in[268] <== states[i+1][269];
		and[271][i] = AND();
		and[271][i].a <== states[i][269];
		and[271][i].b <== eq[27][i].out;
		states[i+1][270] <== and[271][i].out;
		state_changed[i].in[269] <== states[i+1][270];
		and[272][i] = AND();
		and[272][i].a <== states[i][270];
		and[272][i].b <== eq[26][i].out;
		states[i+1][271] <== and[272][i].out;
		state_changed[i].in[270] <== states[i+1][271];
		and[273][i] = AND();
		and[273][i].a <== states[i][271];
		and[273][i].b <== eq[40][i].out;
		states[i+1][272] <== and[273][i].out;
		state_changed[i].in[271] <== states[i+1][272];
		and[274][i] = AND();
		and[274][i].a <== states[i][246];
		and[274][i].b <== eq[20][i].out;
		states[i+1][273] <== and[274][i].out;
		state_changed[i].in[272] <== states[i+1][273];
		and[275][i] = AND();
		and[275][i].a <== states[i][272];
		and[275][i].b <== eq[15][i].out;
		states[i+1][274] <== and[275][i].out;
		state_changed[i].in[273] <== states[i+1][274];
		and[276][i] = AND();
		and[276][i].a <== states[i][274];
		and[276][i].b <== eq[15][i].out;
		states[i+1][275] <== and[276][i].out;
		state_changed[i].in[274] <== states[i+1][275];
		eq[49][i] = IsEqual();
		eq[49][i].in[0] <== in[i];
		eq[49][i].in[1] <== 118;
		and[277][i] = AND();
		and[277][i].a <== states[i][275];
		and[277][i].b <== eq[49][i].out;
		states[i+1][276] <== and[277][i].out;
		state_changed[i].in[275] <== states[i+1][276];
		and[278][i] = AND();
		and[278][i].a <== states[i][276];
		and[278][i].b <== eq[33][i].out;
		states[i+1][277] <== and[278][i].out;
		state_changed[i].in[276] <== states[i+1][277];
		and[279][i] = AND();
		and[279][i].a <== states[i][277];
		and[279][i].b <== eq[25][i].out;
		states[i+1][278] <== and[279][i].out;
		state_changed[i].in[277] <== states[i+1][278];
		and[280][i] = AND();
		and[280][i].a <== states[i][278];
		and[280][i].b <== eq[34][i].out;
		states[i+1][279] <== and[280][i].out;
		state_changed[i].in[278] <== states[i+1][279];
		and[281][i] = AND();
		and[281][i].a <== states[i][279];
		and[281][i].b <== eq[24][i].out;
		states[i+1][280] <== and[281][i].out;
		state_changed[i].in[279] <== states[i+1][280];
		eq[50][i] = IsEqual();
		eq[50][i].in[0] <== in[i];
		eq[50][i].in[1] <== 46;
		and[282][i] = AND();
		and[282][i].a <== states[i][280];
		and[282][i].b <== eq[50][i].out;
		states[i+1][281] <== and[282][i].out;
		state_changed[i].in[280] <== states[i+1][281];
		and[283][i] = AND();
		and[283][i].a <== states[i][281];
		and[283][i].b <== eq[21][i].out;
		states[i+1][282] <== and[283][i].out;
		state_changed[i].in[281] <== states[i+1][282];
		and[284][i] = AND();
		and[284][i].a <== states[i][282];
		and[284][i].b <== eq[24][i].out;
		states[i+1][283] <== and[284][i].out;
		state_changed[i].in[282] <== states[i+1][283];
		and[285][i] = AND();
		and[285][i].a <== states[i][283];
		and[285][i].b <== eq[34][i].out;
		states[i+1][284] <== and[285][i].out;
		state_changed[i].in[283] <== states[i+1][284];
		and[286][i] = AND();
		and[286][i].a <== states[i][284];
		and[286][i].b <== eq[15][i].out;
		states[i+1][285] <== and[286][i].out;
		state_changed[i].in[284] <== states[i+1][285];
		and[287][i] = AND();
		and[287][i].a <== states[i][285];
		and[287][i].b <== eq[21][i].out;
		states[i+1][286] <== and[287][i].out;
		state_changed[i].in[285] <== states[i+1][286];
		and[288][i] = AND();
		and[288][i].a <== states[i][286];
		and[288][i].b <== eq[24][i].out;
		states[i+1][287] <== and[288][i].out;
		state_changed[i].in[286] <== states[i+1][287];
		and[289][i] = AND();
		and[289][i].a <== states[i][287];
		and[289][i].b <== eq[28][i].out;
		states[i+1][288] <== and[289][i].out;
		state_changed[i].in[287] <== states[i+1][288];
		and[290][i] = AND();
		and[290][i].a <== states[i][288];
		and[290][i].b <== eq[33][i].out;
		states[i+1][289] <== and[290][i].out;
		state_changed[i].in[288] <== states[i+1][289];
		eq[51][i] = IsEqual();
		eq[51][i].in[0] <== in[i];
		eq[51][i].in[1] <== 63;
		and[291][i] = AND();
		and[291][i].a <== states[i][289];
		and[291][i].b <== eq[51][i].out;
		states[i+1][290] <== and[291][i].out;
		state_changed[i].in[289] <== states[i+1][290];
		eq[52][i] = IsEqual();
		eq[52][i].in[0] <== in[i];
		eq[52][i].in[1] <== 117;
		and[292][i] = AND();
		and[292][i].a <== states[i][290];
		and[292][i].b <== eq[52][i].out;
		states[i+1][291] <== and[292][i].out;
		state_changed[i].in[290] <== states[i+1][291];
		and[293][i] = AND();
		and[293][i].a <== states[i][291];
		and[293][i].b <== eq[26][i].out;
		states[i+1][292] <== and[293][i].out;
		state_changed[i].in[291] <== states[i+1][292];
		and[294][i] = AND();
		and[294][i].a <== states[i][292];
		and[294][i].b <== eq[33][i].out;
		states[i+1][293] <== and[294][i].out;
		state_changed[i].in[292] <== states[i+1][293];
		and[295][i] = AND();
		and[295][i].a <== states[i][293];
		and[295][i].b <== eq[32][i].out;
		states[i+1][294] <== and[295][i].out;
		state_changed[i].in[293] <== states[i+1][294];
		eq[53][i] = IsEqual();
		eq[53][i].in[0] <== in[i];
		eq[53][i].in[1] <== 95;
		and[296][i] = AND();
		and[296][i].a <== states[i][294];
		and[296][i].b <== eq[53][i].out;
		states[i+1][295] <== and[296][i].out;
		state_changed[i].in[294] <== states[i+1][295];
		and[297][i] = AND();
		and[297][i].a <== states[i][295];
		and[297][i].b <== eq[23][i].out;
		states[i+1][296] <== and[297][i].out;
		state_changed[i].in[295] <== states[i+1][296];
		and[298][i] = AND();
		and[298][i].a <== states[i][296];
		and[298][i].b <== eq[28][i].out;
		states[i+1][297] <== and[298][i].out;
		state_changed[i].in[296] <== states[i+1][297];
		and[299][i] = AND();
		and[299][i].a <== states[i][297];
		and[299][i].b <== eq[29][i].out;
		states[i+1][298] <== and[299][i].out;
		state_changed[i].in[297] <== states[i+1][298];
		and[300][i] = AND();
		and[300][i].a <== states[i][298];
		and[300][i].b <== eq[37][i].out;
		states[i+1][299] <== and[300][i].out;
		state_changed[i].in[298] <== states[i+1][299];
		and[301][i] = AND();
		and[301][i].a <== states[i][273];
		and[301][i].b <== eq[20][i].out;
		states[i+1][300] <== and[301][i].out;
		state_changed[i].in[299] <== states[i+1][300];
		and[302][i] = AND();
		and[302][i].a <== states[i][299];
		and[302][i].b <== eq[38][i].out;
		states[i+1][301] <== and[302][i].out;
		...
		eq[58][i].in[1] <== 57;
		and[303][i] = AND();
		and[303][i].a <== states[i][301];
		multi_or[2][i] = MultiOR(10);
		multi_or[2][i].in[0] <== eq[31][i].out;
		multi_or[2][i].in[1] <== eq[54][i].out;
		multi_or[2][i].in[2] <== eq[30][i].out;
		multi_or[2][i].in[3] <== eq[37][i].out;
		multi_or[2][i].in[4] <== eq[43][i].out;
		multi_or[2][i].in[5] <== eq[55][i].out;
		multi_or[2][i].in[6] <== eq[56][i].out;
		multi_or[2][i].in[7] <== eq[42][i].out;
		multi_or[2][i].in[8] <== eq[57][i].out;
		multi_or[2][i].in[9] <== eq[58][i].out;
		and[303][i].b <== multi_or[2][i].out;
		and[304][i] = AND();
		and[304][i].a <== states[i][302];
		and[304][i].b <== multi_or[2][i].out;
		multi_or[3][i] = MultiOR(2);
		multi_or[3][i].in[0] <== and[303][i].out;
		multi_or[3][i].in[1] <== and[304][i].out;
		states[i+1][302] <== multi_or[3][i].out;
		state_changed[i].in[301] <== states[i+1][302];
		eq[59][i] = IsEqual();
		eq[59][i].in[0] <== in[i];
		eq[59][i].in[1] <== 38;
		and[305][i] = AND();
		and[305][i].a <== states[i][302];
		and[305][i].b <== eq[59][i].out;
		states[i+1][303] <== and[305][i].out;
		state_changed[i].in[302] <== states[i+1][303];
		and[306][i] = AND();
		and[306][i].a <== states[i][303];
		and[306][i].b <== eq[16][i].out;
		states[i+1][304] <== and[306][i].out;
		state_changed[i].in[303] <== states[i+1][304];
		and[307][i] = AND();
		and[307][i].a <== states[i][304];
		and[307][i].b <== eq[21][i].out;
		states[i+1][305] <== and[307][i].out;
		state_changed[i].in[304] <== states[i+1][305];
		and[308][i] = AND();
		and[308][i].a <== states[i][305];
		and[308][i].b <== eq[22][i].out;
		states[i+1][306] <== and[308][i].out;
		state_changed[i].in[305] <== states[i+1][306];
		and[309][i] = AND();
		and[309][i].a <== states[i][306];
		and[309][i].b <== eq[24][i].out;
		states[i+1][307] <== and[309][i].out;
		state_changed[i].in[306] <== states[i+1][307];
		and[310][i] = AND();
		and[310][i].a <== states[i][300];
		and[310][i].b <== eq[0][i].out;
		states[i+1][308] <== and[310][i].out;
		state_changed[i].in[307] <== states[i+1][308];
		and[311][i] = AND();
		and[311][i].a <== states[i][307];
		and[311][i].b <== eq[32][i].out;
		states[i+1][309] <== and[311][i].out;
		state_changed[i].in[308] <== states[i+1][309];
		and[312][i] = AND();
		and[312][i].a <== states[i][309];
		and[312][i].b <== eq[53][i].out;
		states[i+1][310] <== and[312][i].out;
		state_changed[i].in[309] <== states[i+1][310];
		and[313][i] = AND();
		and[313][i].a <== states[i][310];
		and[313][i].b <== eq[23][i].out;
		states[i+1][311] <== and[313][i].out;
		state_changed[i].in[310] <== states[i+1][311];
		and[314][i] = AND();
		and[314][i].a <== states[i][311];
		and[314][i].b <== eq[28][i].out;
		states[i+1][312] <== and[314][i].out;
		state_changed[i].in[311] <== states[i+1][312];
		and[315][i] = AND();
		and[315][i].a <== states[i][312];
		and[315][i].b <== eq[29][i].out;
		states[i+1][313] <== and[315][i].out;
		state_changed[i].in[312] <== states[i+1][313];
		and[316][i] = AND();
		and[316][i].a <== states[i][313];
		and[316][i].b <== eq[37][i].out;
		states[i+1][314] <== and[316][i].out;
		state_changed[i].in[313] <== states[i+1][314];
		and[317][i] = AND();
		and[317][i].a <== states[i][314];
		and[317][i].b <== eq[38][i].out;
		states[i+1][315] <== and[317][i].out;
		state_changed[i].in[314] <== states[i+1][315];
		and[318][i] = AND();
		and[318][i].a <== states[i][315];
		multi_or[4][i] = MultiOR(13);
		multi_or[4][i].in[0] <== eq[13][i].out;
		multi_or[4][i].in[1] <== eq[18][i].out;
		multi_or[4][i].in[2] <== eq[31][i].out;
		multi_or[4][i].in[3] <== eq[54][i].out;
		multi_or[4][i].in[4] <== eq[30][i].out;
		multi_or[4][i].in[5] <== eq[37][i].out;
		multi_or[4][i].in[6] <== eq[43][i].out;
		multi_or[4][i].in[7] <== eq[55][i].out;
		multi_or[4][i].in[8] <== eq[56][i].out;
		multi_or[4][i].in[9] <== eq[42][i].out;
		multi_or[4][i].in[10] <== eq[57][i].out;
		multi_or[4][i].in[11] <== eq[58][i].out;
		multi_or[4][i].in[12] <== eq[29][i].out;
		and[318][i].b <== multi_or[4][i].out;
		and[319][i] = AND();
		and[319][i].a <== states[i][316];
		and[319][i].b <== multi_or[4][i].out;
		multi_or[5][i] = MultiOR(2);
		multi_or[5][i].in[0] <== and[318][i].out;
		multi_or[5][i].in[1] <== and[319][i].out;
		states[i+1][316] <== multi_or[5][i].out;
		state_changed[i].in[315] <== states[i+1][316];
		and[320][i] = AND();
		and[320][i].a <== states[i][316];
		and[320][i].b <== eq[39][i].out;
		states[i+1][317] <== and[320][i].out;
		state_changed[i].in[316] <== states[i+1][317];
		and[321][i] = AND();
		and[321][i].a <== states[i][308];
		and[321][i].b <== eq[16][i].out;
		states[i+1][318] <== and[321][i].out;
		state_changed[i].in[317] <== states[i+1][318];
		and[322][i] = AND();
		and[322][i].a <== states[i][317];
		and[322][i].b <== eq[17][i].out;
		states[i+1][319] <== and[322][i].out;
		state_changed[i].in[318] <== states[i+1][319];
		and[323][i] = AND();
		and[323][i].a <== states[i][319];
		and[323][i].b <== eq[18][i].out;
		states[i+1][320] <== and[323][i].out;
		state_changed[i].in[319] <== states[i+1][320];
		and[324][i] = AND();
		and[324][i].a <== states[i][320];
		and[324][i].b <== eq[13][i].out;
		states[i+1][321] <== and[324][i].out;
		state_changed[i].in[320] <== states[i+1][321];
		and[325][i] = AND();
		and[325][i].a <== states[i][321];
		and[325][i].b <== eq[0][i].out;
		states[i+1][322] <== and[325][i].out;
		state_changed[i].in[321] <== states[i+1][322];
		and[326][i] = AND();
		and[326][i].a <== states[i][322];
		and[326][i].b <== eq[0][i].out;
		...
		and[328][i] = AND();
		and[328][i].a <== states[i][324];
		and[328][i].b <== eq[0][i].out;
		states[i+1][325] <== and[328][i].out;
		state_changed[i].in[324] <== states[i+1][325];
		and[329][i] = AND();
		and[329][i].a <== states[i][325];
		and[329][i].b <== eq[0][i].out;
		states[i+1][326] <== and[329][i].out;
		state_changed[i].in[325] <== states[i+1][326];
		and[330][i] = AND();
		and[330][i].a <== states[i][326];
		and[330][i].b <== eq[0][i].out;
		states[i+1][327] <== and[330][i].out;
		state_changed[i].in[326] <== states[i+1][327];
		and[331][i] = AND();
		and[331][i].a <== states[i][327];
		and[331][i].b <== eq[0][i].out;
		states[i+1][328] <== and[331][i].out;
		state_changed[i].in[327] <== states[i+1][328];
		and[332][i] = AND();
		and[332][i].a <== states[i][328];
		and[332][i].b <== eq[0][i].out;
		states[i+1][329] <== and[332][i].out;
		state_changed[i].in[328] <== states[i+1][329];
		and[333][i] = AND();
		and[333][i].a <== states[i][329];
		and[333][i].b <== eq[0][i].out;
		states[i+1][330] <== and[333][i].out;
		state_changed[i].in[329] <== states[i+1][330];
		and[334][i] = AND();
		and[334][i].a <== states[i][330];
		and[334][i].b <== eq[0][i].out;
		states[i+1][331] <== and[334][i].out;
		state_changed[i].in[330] <== states[i+1][331];
		and[335][i] = AND();
		and[335][i].a <== states[i][331];
		and[335][i].b <== eq[0][i].out;
		states[i+1][332] <== and[335][i].out;
		state_changed[i].in[331] <== states[i+1][332];
		and[336][i] = AND();
		and[336][i].a <== states[i][332];
		and[336][i].b <== eq[0][i].out;
		states[i+1][333] <== and[336][i].out;
		state_changed[i].in[332] <== states[i+1][333];
		and[337][i] = AND();
		and[337][i].a <== states[i][333];
		and[337][i].b <== eq[0][i].out;
		states[i+1][334] <== and[337][i].out;
		state_changed[i].in[333] <== states[i+1][334];
		and[338][i] = AND();
		and[338][i].a <== states[i][334];
		and[338][i].b <== eq[0][i].out;
		states[i+1][335] <== and[338][i].out;
		state_changed[i].in[334] <== states[i+1][335];
		and[339][i] = AND();
		and[339][i].a <== states[i][335];
		and[339][i].b <== eq[0][i].out;
		states[i+1][336] <== and[339][i].out;
		state_changed[i].in[335] <== states[i+1][336];
		and[340][i] = AND();
		and[340][i].a <== states[i][318];
		and[340][i].b <== eq[21][i].out;
		states[i+1][337] <== and[340][i].out;
		state_changed[i].in[336] <== states[i+1][337];
		and[341][i] = AND();
		and[341][i].a <== states[i][336];
		and[341][i].b <== eq[0][i].out;
		states[i+1][338] <== and[341][i].out;
		state_changed[i].in[337] <== states[i+1][338];
		and[342][i] = AND();
		and[342][i].a <== states[i][338];
		and[342][i].b <== eq[0][i].out;
		states[i+1][339] <== and[342][i].out;
		state_changed[i].in[338] <== states[i+1][339];
		and[343][i] = AND();
		and[343][i].a <== states[i][339];
		and[343][i].b <== eq[0][i].out;
		states[i+1][340] <== and[343][i].out;
		state_changed[i].in[339] <== states[i+1][340];
		and[344][i] = AND();
		and[344][i].a <== states[i][340];
		and[344][i].b <== eq[0][i].out;
		states[i+1][341] <== and[344][i].out;
		state_changed[i].in[340] <== states[i+1][341];
		and[345][i] = AND();
		and[345][i].a <== states[i][341];
		and[345][i].b <== eq[0][i].out;
		states[i+1][342] <== and[345][i].out;
		state_changed[i].in[341] <== states[i+1][342];
		and[346][i] = AND();
		and[346][i].a <== states[i][337];
		and[346][i].b <== eq[22][i].out;
		states[i+1][343] <== and[346][i].out;
		state_changed[i].in[342] <== states[i+1][343];
		and[347][i] = AND();
		and[347][i].a <== states[i][343];
		and[347][i].b <== eq[24][i].out;
		states[i+1][344] <== and[347][i].out;
		state_changed[i].in[343] <== states[i+1][344];
		and[348][i] = AND();
		and[348][i].a <== states[i][344];
		and[348][i].b <== eq[32][i].out;
		states[i+1][345] <== and[348][i].out;
		state_changed[i].in[344] <== states[i+1][345];
		and[349][i] = AND();
		and[349][i].a <== states[i][345];
		and[349][i].b <== eq[0][i].out;
		states[i+1][346] <== and[349][i].out;
		state_changed[i].in[345] <== states[i+1][346];
		and[350][i] = AND();
		and[350][i].a <== states[i][346];
		and[350][i].b <== eq[25][i].out;
		states[i+1][347] <== and[350][i].out;
		state_changed[i].in[346] <== states[i+1][347];
		and[351][i] = AND();
		and[351][i].a <== states[i][347];
		and[351][i].b <== eq[16][i].out;
		states[i+1][348] <== and[351][i].out;
		state_changed[i].in[347] <== states[i+1][348];
		and[352][i] = AND();
		and[352][i].a <== states[i][348];
		and[352][i].b <== eq[34][i].out;
		states[i+1][349] <== and[352][i].out;
		state_changed[i].in[348] <== states[i+1][349];
		and[353][i] = AND();
		and[353][i].a <== states[i][349];
		and[353][i].b <== eq[33][i].out;
		states[i+1][350] <== and[353][i].out;
		state_changed[i].in[349] <== states[i+1][350];
		and[354][i] = AND();
		and[354][i].a <== states[i][350];
		and[354][i].b <== eq[0][i].out;
		states[i+1][351] <== and[354][i].out;
		state_changed[i].in[350] <== states[i+1][351];
		and[355][i] = AND();
		and[355][i].a <== states[i][351];
		and[355][i].b <== eq[20][i].out;
		states[i+1][352] <== and[355][i].out;
		state_changed[i].in[351] <== states[i+1][352];
		and[356][i] = AND();
		and[356][i].a <== states[i][2];
		and[356][i].b <== eq[18][i].out;
		states[i+1][353] <== and[356][i].out;
		state_changed[i].in[352] <== states[i+1][353];
		and[357][i] = AND();
		and[357][i].a <== states[i][352];
		and[357][i].b <== eq[20][i].out;
		states[i+1][354] <== and[357][i].out;
		state_changed[i].in[353] <== states[i+1][354];
		and[358][i] = AND();
		and[358][i].a <== states[i][354];
		and[358][i].b <== eq[17][i].out;
		states[i+1][355] <== and[358][i].out;
		state_changed[i].in[354] <== states[i+1][355];
		and[359][i] = AND();
		and[359][i].a <== states[i][355];
		and[359][i].b <== eq[18][i].out;
		states[i+1][356] <== and[359][i].out;
		state_changed[i].in[355] <== states[i+1][356];
		and[360][i] = AND();
		and[360][i].a <== states[i][356];
		and[360][i].b <== eq[13][i].out;
		states[i+1][357] <== and[360][i].out;
		state_changed[i].in[356] <== states[i+1][357];
		and[361][i] = AND();
		and[361][i].a <== states[i][357];
		and[361][i].b <== eq[0][i].out;
		states[i+1][358] <== and[361][i].out;
		state_changed[i].in[357] <== states[i+1][358];
		and[362][i] = AND();
		and[362][i].a <== states[i][358];
		and[362][i].b <== eq[0][i].out;
		states[i+1][359] <== and[362][i].out;
		state_changed[i].in[358] <== states[i+1][359];
		and[363][i] = AND();
		and[363][i].a <== states[i][359];
		and[363][i].b <== eq[0][i].out;
		states[i+1][360] <== and[363][i].out;
		state_changed[i].in[359] <== states[i+1][360];
		and[364][i] = AND();
		and[364][i].a <== states[i][360];
		and[364][i].b <== eq[0][i].out;
		states[i+1][361] <== and[364][i].out;
		state_changed[i].in[360] <== states[i+1][361];
		states[i+1][0] <== 1 - state_changed[i].out;
	}

	component final_state_result = MultiOR(num_bytes+1);
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][201];
	}
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][201] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][301] * states[i+2][302];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][302] * states[i+2][302];
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr1[i][0] <== 0;
		is_substr1[i][1] <== is_substr1[i][0] + states[i+1][315] * states[i+2][316];
		is_substr1[i][2] <== is_substr1[i][1] + states[i+1][316] * states[i+2][316];
