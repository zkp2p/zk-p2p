...
template VenmoActorIdRegex(msg_bytes) {
	...
	component eq[397][num_bytes];
	component lt[4][num_bytes];
	component and[335][num_bytes];
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		and[55][i] = AND();
		and[55][i].a <== states[i][52];
		and[55][i].b <== eq[0][i].out;
		states[i+1][53] <== and[55][i].out;
		state_changed[i].in[52] <== states[i+1][53];
		and[56][i] = AND();
		and[56][i].a <== states[i][53];
		and[56][i].b <== eq[0][i].out;
		states[i+1][54] <== and[56][i].out;
		state_changed[i].in[53] <== states[i+1][54];
		and[57][i] = AND();
		and[57][i].a <== states[i][54];
		and[57][i].b <== eq[0][i].out;
		states[i+1][55] <== and[57][i].out;
		state_changed[i].in[54] <== states[i+1][55];
		and[58][i] = AND();
		and[58][i].a <== states[i][55];
		and[58][i].b <== eq[0][i].out;
		states[i+1][56] <== and[58][i].out;
		state_changed[i].in[55] <== states[i+1][56];
		and[59][i] = AND();
		and[59][i].a <== states[i][56];
		and[59][i].b <== eq[0][i].out;
		states[i+1][57] <== and[59][i].out;
		state_changed[i].in[56] <== states[i+1][57];
		and[60][i] = AND();
		and[60][i].a <== states[i][57];
		and[60][i].b <== eq[0][i].out;
		states[i+1][58] <== and[60][i].out;
		state_changed[i].in[57] <== states[i+1][58];
		and[61][i] = AND();
		and[61][i].a <== states[i][58];
		and[61][i].b <== eq[0][i].out;
		states[i+1][59] <== and[61][i].out;
		state_changed[i].in[58] <== states[i+1][59];
		and[62][i] = AND();
		and[62][i].a <== states[i][59];
		and[62][i].b <== eq[0][i].out;
		states[i+1][60] <== and[62][i].out;
		state_changed[i].in[59] <== states[i+1][60];
		and[63][i] = AND();
		and[63][i].a <== states[i][60];
		and[63][i].b <== eq[0][i].out;
		states[i+1][61] <== and[63][i].out;
		state_changed[i].in[60] <== states[i+1][61];
		and[64][i] = AND();
		and[64][i].a <== states[i][61];
		and[64][i].b <== eq[0][i].out;
		states[i+1][62] <== and[64][i].out;
		state_changed[i].in[61] <== states[i+1][62];
		and[65][i] = AND();
		and[65][i].a <== states[i][62];
		and[65][i].b <== eq[13][i].out; // 60 = `<`
		states[i+1][63] <== and[65][i].out;
		state_changed[i].in[62] <== states[i+1][63];
		and[66][i] = AND();
		and[66][i].a <== states[i][63];
		and[66][i].b <== eq[14][i].out;
		states[i+1][64] <== and[66][i].out;
		...
		and[67][i].b <== eq[87][i].out;
		states[i+1][65] <== and[67][i].out;
		...
		eq[88][i].in[1] <== 105;
		and[68][i] = AND();
		and[68][i].a <== states[i][65];
		and[68][i].b <== eq[88][i].out;
		states[i+1][66] <== and[68][i].out;
		...
		and[229][i].b <== eq[112][i].out; // 111 = `o`
		...
		multi_or[2][i].in[0] <== eq[28][i].out; // 10 = `\n`
		multi_or[2][i].in[1] <== eq[50][i].out; // 13 = `\r`
		multi_or[2][i].in[2] <== eq[69][i].out; // 48 = `0`
		multi_or[2][i].in[3] <== eq[273][i].out;
		multi_or[2][i].in[4] <== eq[68][i].out; // 50 = `2`
		multi_or[2][i].in[5] <== eq[139][i].out; // 51 = `3`
		multi_or[2][i].in[6] <== eq[153][i].out; // 52 = `4`
		multi_or[2][i].in[7] <== eq[277][i].out; // 53 = `5`
		multi_or[2][i].in[8] <== eq[278][i].out; // 54 = `6`
		multi_or[2][i].in[9] <== eq[152][i].out; // 55 = `7`
		multi_or[2][i].in[10] <== eq[280][i].out;
		multi_or[2][i].in[11] <== eq[281][i].out;
		multi_or[2][i].in[12] <== eq[67][i].out; // 61 = `=`
		...
		and[252][i].b <== eq[147][i].out; // 114 = `r`
