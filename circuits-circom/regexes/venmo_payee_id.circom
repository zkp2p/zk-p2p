...
template VenmoPayeeIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		...
		multi_or[3][i].in[0] <== eq[270][i].out;
		multi_or[3][i].in[1] <== eq[271][i].out;
		multi_or[3][i].in[2] <== eq[272][i].out;
		multi_or[3][i].in[3] <== eq[273][i].out;
		multi_or[3][i].in[4] <== eq[274][i].out;
		multi_or[3][i].in[5] <== eq[275][i].out;
		multi_or[3][i].in[6] <== eq[276][i].out;
		multi_or[3][i].in[7] <== eq[277][i].out;
		multi_or[3][i].in[8] <== eq[278][i].out;
		multi_or[3][i].in[9] <== eq[279][i].out;
		multi_or[3][i].in[10] <== eq[280][i].out;
		multi_or[3][i].in[11] <== eq[281][i].out;
		multi_or[3][i].in[12] <== eq[282][i].out;
		...
		multi_or[4][i].in[0] <== eq[283][i].out;
		multi_or[4][i].in[1] <== eq[284][i].out;
		multi_or[4][i].in[2] <== eq[285][i].out;
		multi_or[4][i].in[3] <== eq[286][i].out;
		multi_or[4][i].in[4] <== eq[287][i].out;
		multi_or[4][i].in[5] <== eq[288][i].out;
		multi_or[4][i].in[6] <== eq[289][i].out;
		multi_or[4][i].in[7] <== eq[290][i].out;
		multi_or[4][i].in[8] <== eq[291][i].out;
		multi_or[4][i].in[9] <== eq[292][i].out;
		multi_or[4][i].in[10] <== eq[293][i].out;
		multi_or[4][i].in[11] <== eq[294][i].out;
		multi_or[4][i].in[12] <== eq[295][i].out;
		and[251][i].b <== multi_or[4][i].out;
		multi_or[5][i] = MultiOR(2);
		multi_or[5][i].in[0] <== and[250][i].out;
		multi_or[5][i].in[1] <== and[251][i].out;
		states[i+1][248] <== multi_or[5][i].out;
		...
		multi_or[6][i].in[0] <== eq[310][i].out;
		multi_or[6][i].in[1] <== eq[311][i].out;
		multi_or[6][i].in[2] <== eq[312][i].out;
		multi_or[6][i].in[3] <== eq[313][i].out;
		multi_or[6][i].in[4] <== eq[314][i].out;
		multi_or[6][i].in[5] <== eq[315][i].out;
		multi_or[6][i].in[6] <== eq[316][i].out;
		multi_or[6][i].in[7] <== eq[317][i].out;
		multi_or[6][i].in[8] <== eq[318][i].out;
		multi_or[6][i].in[9] <== eq[319][i].out;
		and[266][i].b <== multi_or[6][i].out;
		eq[320][i] = IsEqual();
		eq[320][i].in[0] <== in[i];
		eq[320][i].in[1] <== 48;
		eq[321][i] = IsEqual();
		...
		multi_or[7][i].in[0] <== eq[320][i].out;
		multi_or[7][i].in[1] <== eq[321][i].out;
		multi_or[7][i].in[2] <== eq[322][i].out;
		multi_or[7][i].in[3] <== eq[323][i].out;
		multi_or[7][i].in[4] <== eq[324][i].out;
		multi_or[7][i].in[5] <== eq[325][i].out;
		multi_or[7][i].in[6] <== eq[326][i].out;
		multi_or[7][i].in[7] <== eq[327][i].out;
		multi_or[7][i].in[8] <== eq[328][i].out;
		multi_or[7][i].in[9] <== eq[329][i].out;
		and[267][i].b <== multi_or[7][i].out;
		multi_or[8][i] = MultiOR(2);
		multi_or[8][i].in[0] <== and[266][i].out;
		multi_or[8][i].in[1] <== and[267][i].out;
		states[i+1][263] <== multi_or[8][i].out;
