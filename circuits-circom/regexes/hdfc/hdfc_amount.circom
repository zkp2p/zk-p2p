...
template HdfcAmountRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		state_changed[i] = MultiOR(58);
		eq[0][i] = IsEqual();
		eq[0][i].in[0] <== in[i];
		eq[0][i].in[1] <== 115;
		and[0][i] = AND();
		and[0][i].a <== states[i][58];
	...
	signal is_substr0[msg_bytes][33];
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][4] <== is_substr0[i][3] + states[i+1][4] * states[i+2][6];
		is_substr0[i][5] <== is_substr0[i][4] + states[i+1][6] * states[i+2][7];
		...
		is_substr0[i][25] <== is_substr0[i][24] + states[i+1][26] * states[i+2][27];
		is_substr0[i][26] <== is_substr0[i][25] + states[i+1][27] * states[i+2][28];
		is_substr0[i][27] <== is_substr0[i][26] + states[i+1][28] * states[i+2][29];
		is_substr0[i][28] <== is_substr0[i][27] + states[i+1][29] * states[i+2][30];
		is_substr0[i][29] <== is_substr0[i][28] + states[i+1][30] * states[i+2][32];
		is_substr0[i][30] <== is_substr0[i][29] + states[i+1][32] * states[i+2][33];
		is_substr0[i][31] <== is_substr0[i][30] + states[i+1][33] * states[i+2][34];
		is_substr0[i][32] <== is_substr0[i][31] + states[i+1][34] * states[i+2][35];
		is_reveal0[i] <== is_substr0[i][32] * is_consecutive[i][1];
