...
template VenmoReceiveIdRegex(msg_bytes) {
	...
	for (var i = 0; i < num_bytes; i++) {
		state_changed[i] = MultiOR(148);
		eq[0][i] = IsEqual();
		eq[0][i].in[0] <== in[i];
		eq[0][i].in[1] <== 32;
		and[0][i] = AND();
		and[0][i].a <== states[i][148];
		...
		and[79][i].b <== eq[15][i].out;
		states[i+1][80] <== and[79][i].out;
		state_changed[i].in[79] <== states[i+1][80];
		and[80][i] = AND();
		and[80][i].a <== states[i][54];
		and[80][i].b <== eq[23][i].out;
		...
		multi_or[0][i].in[0] <== eq[17][i].out;
		multi_or[0][i].in[1] <== eq[40][i].out;
		multi_or[0][i].in[2] <== eq[41][i].out;
		multi_or[0][i].in[3] <== eq[9][i].out;
		multi_or[0][i].in[4] <== eq[19][i].out;
		multi_or[0][i].in[5] <== eq[42][i].out;
		multi_or[0][i].in[6] <== eq[43][i].out;
		multi_or[0][i].in[7] <== eq[18][i].out;
		multi_or[0][i].in[8] <== eq[44][i].out;
		multi_or[0][i].in[9] <== eq[45][i].out;
		and[109][i].b <== multi_or[0][i].out;
		and[110][i] = AND();
		and[110][i].a <== states[i][110];
		and[110][i].b <== multi_or[0][i].out;
		multi_or[1][i] = MultiOR(2);
		multi_or[1][i].in[0] <== and[109][i].out;
		multi_or[1][i].in[1] <== and[110][i].out;
		states[i+1][110] <== multi_or[1][i].out;
		state_changed[i].in[109] <== states[i+1][110];
		eq[46][i] = IsEqual();
		eq[46][i].in[0] <== in[i];
		eq[46][i].in[1] <== 38;
		and[111][i] = AND();
		and[111][i].a <== states[i][110];
		and[111][i].b <== eq[46][i].out;
		states[i+1][111] <== and[111][i].out;
		state_changed[i].in[110] <== states[i+1][111];
		and[112][i] = AND();
		and[112][i].a <== states[i][111];
		and[112][i].b <== eq[2][i].out;
		states[i+1][112] <== and[112][i].out;
		state_changed[i].in[111] <== states[i+1][112];
		and[113][i] = AND();
		and[113][i].a <== states[i][112];
		and[113][i].b <== eq[12][i].out;
		states[i+1][113] <== and[113][i].out;
		state_changed[i].in[112] <== states[i+1][113];
		and[114][i] = AND();
		and[114][i].a <== states[i][113];
		and[114][i].b <== eq[4][i].out;
		states[i+1][114] <== and[114][i].out;
		state_changed[i].in[113] <== states[i+1][114];
		and[115][i] = AND();
		and[115][i].a <== states[i][114];
		and[115][i].b <== eq[13][i].out;
		states[i+1][115] <== and[115][i].out;
		state_changed[i].in[114] <== states[i+1][115];
		and[116][i] = AND();
		and[116][i].a <== states[i][108];
		and[116][i].b <== eq[0][i].out;
		states[i+1][116] <== and[116][i].out;
		state_changed[i].in[115] <== states[i+1][116];
		and[117][i] = AND();
		and[117][i].a <== states[i][115];
		and[117][i].b <== eq[14][i].out;
		states[i+1][117] <== and[117][i].out;
		state_changed[i].in[116] <== states[i+1][117];
		and[118][i] = AND();
		and[118][i].a <== states[i][117];
		and[118][i].b <== eq[39][i].out;
		states[i+1][118] <== and[118][i].out;
		state_changed[i].in[117] <== states[i+1][118];
		and[119][i] = AND();
		and[119][i].a <== states[i][118];
		and[119][i].b <== eq[25][i].out;
		states[i+1][119] <== and[119][i].out;
		state_changed[i].in[118] <== states[i+1][119];
		and[120][i] = AND();
		and[120][i].a <== states[i][119];
		and[120][i].b <== eq[24][i].out;
		states[i+1][120] <== and[120][i].out;
		state_changed[i].in[119] <== states[i+1][120];
		and[121][i] = AND();
		and[121][i].a <== states[i][120];
		and[121][i].b <== eq[8][i].out;
		states[i+1][121] <== and[121][i].out;
		state_changed[i].in[120] <== states[i+1][121];
		and[122][i] = AND();
		and[122][i].a <== states[i][121];
		and[122][i].b <== eq[9][i].out;
		states[i+1][122] <== and[122][i].out;
		state_changed[i].in[121] <== states[i+1][122];
		and[123][i] = AND();
		and[123][i].a <== states[i][122];
		and[123][i].b <== eq[10][i].out;
		states[i+1][123] <== and[123][i].out;
		state_changed[i].in[122] <== states[i+1][123];
		and[124][i] = AND();
		and[124][i].a <== states[i][123];
		multi_or[2][i] = MultiOR(13);
		multi_or[2][i].in[0] <== eq[31][i].out;
		multi_or[2][i].in[1] <== eq[30][i].out;
		multi_or[2][i].in[2] <== eq[17][i].out;
		multi_or[2][i].in[3] <== eq[40][i].out;
		multi_or[2][i].in[4] <== eq[41][i].out;
		multi_or[2][i].in[5] <== eq[9][i].out;
		multi_or[2][i].in[6] <== eq[19][i].out;
		multi_or[2][i].in[7] <== eq[42][i].out;
		multi_or[2][i].in[8] <== eq[43][i].out;
		multi_or[2][i].in[9] <== eq[18][i].out;
		multi_or[2][i].in[10] <== eq[44][i].out;
		multi_or[2][i].in[11] <== eq[45][i].out;
		multi_or[2][i].in[12] <== eq[8][i].out;
		and[124][i].b <== multi_or[2][i].out;
		and[125][i] = AND();
		and[125][i].a <== states[i][124];
		and[125][i].b <== multi_or[2][i].out;
		multi_or[3][i] = MultiOR(2);
		multi_or[3][i].in[0] <== and[124][i].out;
		multi_or[3][i].in[1] <== and[125][i].out;
		states[i+1][124] <== multi_or[3][i].out;
		state_changed[i].in[123] <== states[i+1][124];
		and[126][i] = AND();
		and[126][i].a <== states[i][124];
		and[126][i].b <== eq[11][i].out;
		states[i+1][125] <== and[126][i].out;
		state_changed[i].in[124] <== states[i+1][125];
		and[127][i] = AND();
		and[127][i].a <== states[i][116];
	...
	for (var i = 0; i <= num_bytes; i++) {
		final_state_result.in[i] <== states[i][129];
	}
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_consecutive[msg_bytes-1-i][0] <== states[num_bytes-i][129] * (1 - is_consecutive[msg_bytes-i][1]) + is_consecutive[msg_bytes-i][1];
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr0[i][0] <== 0;
		is_substr0[i][1] <== is_substr0[i][0] + states[i+1][109] * states[i+2][110];
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][110] * states[i+2][110];
	...
	for (var i = 0; i < msg_bytes; i++) {
		is_substr1[i][0] <== 0;
		is_substr1[i][1] <== is_substr1[i][0] + states[i+1][123] * states[i+2][124];
		is_substr1[i][2] <== is_substr1[i][1] + states[i+1][124] * states[i+2][124];
